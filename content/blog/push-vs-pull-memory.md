---
title: "Push vs Pull Memory: A Better Way to Think About AI Agent Memory"
description: "Most AI agent memory is pull: a store you query. The alternative is push: a loop your agent runs. Here is the difference and when each one matters."
